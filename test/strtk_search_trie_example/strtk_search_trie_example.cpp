...
void trie_example01()
{
    ...
    for (std::size_t i = 0; i < l_size; ++i)
    {
        ...
        {
            std::cout << "Found Prefix: " << strtk::join(",", i_list[i],
                      i_list[i] + l_size) << std::endl;
        }
    }
...
bool trie_example02()
{
...

    {
        ...
        std::cout << strtk::text::left_align(14,' ',
                                             "[strtk::trie]") << "String Count: " << count << " Total Time: " << t.time()
                  <<std::endl;
    }

    {
        ...
        std::cout << strtk::text::left_align(14,' ',
                                             "[std::map]") << "String Count: " << count << " Total Time: " << t.time()
                  <<std::endl;
    }

    {
        ...
        std::cout << strtk::text::left_align(14,' ',
                                             "[std::set]") << "String Count: " << count << " Total Time: " << t.time()
                  <<std::endl;
    }
