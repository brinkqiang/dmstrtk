...
void parse_test02()
{
    static const std::string data =
        "-1140639 -1352246 -1364216  -139556 -1508745 -1613887 -1785865  -189043 -2587409  -277311 "
    ...
    std::cout << strtk::text::left_align(title_length(), ' ',
                                         "[integer into " + strtk::type_name(vec_int) + "]");
...
{
    static const std::string data =
        "-1140639.1140639 -1352246.1352246 -1364216.1352246 -1395560.1395560 -1508745.1508745 "
    ...
    std::cout << strtk::text::left_align(title_length(), ' ',
                                         "[double into " + strtk::type_name(vec_double) + "]");
...
void parse_test04()
{
    ...
    {
        std::cout << strtk::text::left_align(title_length(), ' ',
                                             "[even columns into " + strtk::type_name(x) + "] ");
        ...
        for (std::size_t i = 0; i < rounds; ++i)
        {
            strtk::parse_columns(data, ",", strtk::column_list(0, 2, 4, 6, 8), x[0], x[1],
                                 x[2], x[3], x[4]);
        }
    ...
    {
        std::cout << strtk::text::left_align(title_length(), ' ',
                                             "[ odd columns into " + strtk::type_name(x) + "] ");
        ...
        for (std::size_t i = 0; i < rounds; ++i)
        {
            strtk::parse_columns(data, ",", strtk::column_list(1, 3, 5, 7, 9), x[0], x[1],
                                 x[2], x[3], x[4]);
        }
...
static const std::string md_base =
    "a+bc=def ghij-klmno?pqrstu&vwxyzAB@CDEFGHIJ~KLMNOPQRS#TUVWXYZ012|3456789abcd|efghijklmnopqrsdu!";
static const std::size_t md_replicate_count = 1000000;
static const std::string md_delimiters =
    "-+=~&*[]{}()<>|!?@^%$#\".,;:_ /\\\t\r\n";
...
static const std::string sd_base =
    "a|bc|def|ghij|klmno|pqrstu|vwxyzAB|CDEFGHIJ|KLMNOPQRS|TUVWXYZ012|3456789!@#$|^&*(){}[]<>?:;,~|";
