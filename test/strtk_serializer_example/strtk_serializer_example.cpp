...
bool example02(char* buffer, const unsigned int buffer_size)
{
...

    {
        ...
        for (std::size_t i = 0; i < rounds; ++i)
        {
            ...
            if (p_in != p_expected)
            {
                std::cout << "example02() - Comparison between expected and read failed @ " << i
                          << std::endl;
                return false;
            }
        }
...
bool example03(char* buffer, const unsigned int buffer_size)
{
...

    {
        ...
        for (unsigned int i = 0; i < rounds; ++i)
        {
            ...
            if (p_in != p_expected)
            {
                std::cout << "example03() - Comparison between expected and read failed @ " << i
                          << std::endl;
                return false;
            }
...
{
    {
...

        {
            ...
            if (!writer(lst))
            {
                std::cout << "example04() - Failed to write list of 'unsigned int'" <<
                          std::endl;
                return false;
            }
...

        {
            ...
            for (unsigned int i = 0; i < max_count; ++i)
            {
                if (lst[i] != i)
                {
                    std::cout << "example04() - 'unsigned int' failure at index: " << i <<
                              std::endl;
                    return false;
                }
            }
...

    {
...

        {
            ...
            if (!writer(lst))
            {
                std::cout << "example04() - Failed to write list of " << strtk::type_name(
                              lst) << std::endl;
                return false;
            }
...

        {
            ...
            if (!reader(lst))
            {
                std::cout << "example04() - Failed to read list of " << strtk::type_name(
                              lst) << std::endl;
                return false;
            }
...

    {
        ...
        if (!writer(p1_out))
        {
            std::cout << "example04() - Failed to write type: " << strtk::type_name(
                          p1_out) << std::endl;
            return false;
        }
        ...
        if (!reader(p1_in))
        {
            std::cout << "example04() - Failed to read type: " << strtk::type_name(
                          p1_in) << std::endl;
            return false;
        }
        ...
        if (p1_in != p1_out)
        {
            std::cout << "example04() - Comparison between p1_in and p1_out failed." <<
                      std::endl;
            return false;
        }
        ...
        if (p2_in != p2_out)
        {
            std::cout << "example04() - Comparison between p2_in and p2_out failed." <<
                      std::endl;
            return false;
        }
        ...
        if (p3_in != p3_out)
        {
            std::cout << "example04() - Comparison between p3_in and p3_out failed." <<
                      std::endl;
            return false;
        }
        ...
        if (p4_in != p4_out)
        {
            std::cout << "example04() - Comparison between p4_in and p4_out failed." <<
                      std::endl;
            return false;
        }
    }

    {
        ...
        {
            std::cout << "example04() - Failure between sizes of p_out_list and p_in_list!"
                      << std::endl;
            return false;
        }
        ...
        {
            std::cout <<
                      "example04() - Failure in comparison between p_out_list and p_in_list!" <<
                      std::endl;
            return false;
        }
    }
...

        {
            ...
            for (std::size_t r = 0; r < rounds; ++r)
            {
                ...
                for (std::size_t i = 0; i < person_count; ++i)
                {
                    if (!writer(p))
                    {
                        std::cout << "example05() - Failed to write index " << i << " @ round " << r <<
                                  std::endl;
                        return false;
                    }
                }
...

        {
            ...
            for (std::size_t r = 0; r < rounds; ++r)
            {
                ...
                for (std::size_t i = 0; i < person_count; ++i)
                {
                    if (!reader(p))
                    {
                        std::cout << "example05() - Failed to read index " << i << " @ round " << r <<
                                  std::endl;
                        return false;
                    }
                }
...

    {
...

        {
            ...
            for (std::size_t r = 0; r < rounds; ++r)
            {
                ...
                if (!writer(dbl_list))
                {
                    std::cout << "example05() - Failed to write " << strtk::type_name(
                                  dbl_list) << " @ round " << r << std::endl;
                    return false;
                }
...

        {
            ...
            for (std::size_t r = 0; r < rounds; ++r)
            {
                ...
                if (!reader(dbl_list))
                {
                    std::cout << "example05() - Failed to read " << strtk::type_name(
                                  dbl_list) << " @ round " << r << std::endl;
                    return false;
                }
...

    {
...

        {
            ...
            for (std::size_t r = 0; r < rounds; ++r)
            {
                ...
                if (!writer(str_list))
                {
                    std::cout << "example05() - Failed to write string permutation " <<
                              strtk::type_name(str_list) << " @ round " << r << std::endl;
                    return false;
                }
...

        {
            ...
            for (std::size_t r = 0; r < rounds; ++r)
            {
                ...
                if (!reader(str_list))
                {
                    std::cout << "example05() - Failed to read string permutation " <<
                              strtk::type_name(str_list) << " @ round " << r << std::endl;
                    return false;
                }
...
bool example09(char* buffer)
{
    ...
    if (in_char    != out_char)
    {
        std::cout << "example06() - Failed char"    << std::endl;
        return false;
    }

    if (in_uchar   != out_uchar)
    {
        std::cout << "example06() - Failed uchar"   << std::endl;
        return false;
    }

    if (in_short   != out_short)
    {
        std::cout << "example06() - Failed short"   << std::endl;
        return false;
    }

    if (in_ushort  != out_ushort)
    {
        std::cout << "example06() - Failed ushort"  << std::endl;
        return false;
    }

    if (in_int     != out_int)
    {
        std::cout << "example06() - Failed int"     << std::endl;
        return false;
    }

    if (in_uint    != out_uint)
    {
        std::cout << "example06() - Failed uint"    << std::endl;
        return false;
    }

    if (in_long    != out_long)
    {
        std::cout << "example06() - Failed long"    << std::endl;
        return false;
    }

    if (in_ulong   != out_ulong)
    {
        std::cout << "example06() - Failed ulong"   << std::endl;
        return false;
    }

    if (in_float   != out_float)
    {
        std::cout << "example06() - Failed float"   << std::endl;
        return false;
    }

    if (in_double  != out_double)
    {
        std::cout << "example06() - Failed double"  << std::endl;
        return false;
    }

    if (in_ldouble != out_ldouble)
    {
        std::cout << "example06() - Failed ldouble" << std::endl;
        return false;
    }
